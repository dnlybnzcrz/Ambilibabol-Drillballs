...
const Description3 = ({ route, navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <Text style={[styles.title, { fontFamily: FontFamily.poppinsBold, fontSize: 30 }]}>BEHIND THE BACK</Text>
        <Text style={styles.drillInfo}>
          It's used to evade defenders, change direction, or create space. 
          Executed with speed and precision, it requires coordination and ball-handling proficiency.
        </Text>
        <View style={styles.separator} />
        <Text style={styles.tipsTitle}>TIPS:</Text>
        <Text style={styles.tip}>• Don’t wrap it around behind your back, that takes a lot of your speed </Text>
        <Text style={styles.tip}>• It sames as dribbling in front from left to right</Text>
        <Text style={[styles.tipsTitle, { fontFamily: 'Poppins-Bold', fontSize: 25 }]}>WORKOUT PLAN</Text>
        <Text style={[styles.tipsTitle, { fontFamily: 'Poppins-Bold' }]}>From Left Hand to Right Hand while crossing behind the back:</Text>
        ...
        <Text style={[styles.tipsTitle, { fontFamily: 'Poppins-Bold' }]}>From Right Hand to Left Hand while crossing behind the back:</Text>
        <Text style={[styles.tip, { fontFamily: 'Poppins-Bold' }]}>• 2-3 reps</Text>
        <Text style={[styles.tip, { fontFamily: 'Poppins-Bold' }]}>• 1 Minute per reps.</Text>
        <Text style={[styles.tip, { fontFamily: 'Poppins-Bold' }]}>• First Rep: Slow</Text>
        <Text style={[styles.tip, { fontFamily: 'Poppins-Bold' }]}>• 2nd Rep: Mid Fast</Text>
